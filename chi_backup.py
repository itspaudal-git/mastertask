			...
			if meal['totalMeals']>0:
				...
				for component in meal['billOfMaterials']:
					...
					try:
						...
						# 	tasks.append(TKS.Task(cycle, component['title'] + " [" + str(round(component['qtyPounds']*GRAMS_PER_LB))+" g]" + " Add on", 'Tray Portioning and Sealing','Tray Portioning and Sealing: (1 Drop)', _inputs = [TKS.Task_I_O(component['qtyPounds']*GRAMS_PER_LB, 'Grams',component['partID'])], _outputs = [TKS.Task_I_O(meal['totalMeals']*multiplier,\
						# 		'Tray',"")], _process_yield = 1, _planned_location = facility, _planned_day = portion_day, _meals = [meal['mealCode']], _parents = [meal['apiMealTitle']], _target_weight = component['qtyPounds']*GRAMS_PER_LB))
						# 	if(_verbosity <= VL_INFORMATIONAL):
						# 		print("Added Band Sealingto %s on %s" % (facility,portion_day))
...
if __name__ == "__main__":
	...
	spreadsheet_id = "1ALTgMXhFi-7aibx1FO_5zaQ0vljuXwWdQVrkaMrw1aI"  #Production Schedule Prototype
